...
public class AngebotVerwaltenPHP extends AsyncTask<String, Void, String> {
    String angebotVerwaltenResult = null;

    @Override
    protected String doInBackground(String... params) {

        try{
            angebotVerwaltenResult = sendRequest(params[0]);
        } catch (Exception e) {
            return "keine Internetverbindung";
        }
        Log.d(this.getClass().getName(), angebotVerwaltenResult);

        return angebotVerwaltenResult;
    }

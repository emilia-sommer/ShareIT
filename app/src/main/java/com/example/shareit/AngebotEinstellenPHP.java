...
public class AngebotEinstellenPHP extends AsyncTask<String, Void, String> {
    String angebotEinstellenResult = null;

    @Override
    protected String doInBackground(String... params) {

        try{
            angebotEinstellenResult = sendRequest(params[0]);
        } catch (Exception e) {
            return "keine Internetverbindung";
        }
        Log.d(this.getClass().getName(), angebotEinstellenResult);

        return angebotEinstellenResult;
    }
